...
export default function Login() {
  return (
    <>
      <Head>
        <title>Login - Q-AdMix</title>
      </Head>
      <main className='w-full h-screen flex flex-col items-center justify-center px-4'>
        <div className='max-w-sm w-full text-gray-300'>
          <div className='text-center'>
            <Brand className='mx-auto w-40' />
            <div className='mt-5 space-y-2'>
              <h1 className='text-white text-2xl font-bold sm:text-3xl'>
                Welcome to Q-AdMix
              </h1>
              <p className='text-gray-300'>
                Hybrid quantum-classical AI for digital advertising optimization
              </p>
              <p className='text-sm text-gray-400'>
                Don't have an account?{" "}
                <Link
                  href='/#pricing'
                  className='font-medium text-purple-400 hover:text-purple-300 duration-150'>
                  Request a Demo
                </Link>
              </p>
            </div>
