          ...
          <div className="relative z-10">
            <div className="max-w-xl mx-auto text-center">
              ...
              <p className="mt-5 text-gray-300">
                Q-AdMix's hybrid quantum-classical AI optimizes your ad spend, maximizes ROI, and delivers better
                results across all your advertising channels. See the difference quantum can make.
              </p>
            </div>
