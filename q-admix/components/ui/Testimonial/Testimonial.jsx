  ...
  const testimonials = [
    {
      ...
      quote:
        "Q-AdMix transformed our advertising strategy. The quantum-powered optimization increased our ROI by 47% in just three months while reducing our customer acquisition costs by 35%.",
    },
    {
      avatar: user2,
      name: "Michael Chen",
      ...
      quote:
        "The cross-platform optimization from Q-AdMix is revolutionary. We're seeing consistently better performance across all our channels without increasing our ad spend.",
    },
    {
      avatar: user3,
      ...
      quote:
        "As a performance marketing agency, we've tried every tool out there. Q-AdMix's predictive analytics are in a league of their own. Our clients are thrilled with the results.",
    },
    {
      avatar: user4,
      name: "David Kim",
      ...
      quote:
        "The ROI forecasting is scarily accurate. We've been able to make data-driven decisions with confidence, and it's paying off in our campaign performance.",
    },
    {
      avatar: user5,
      name: "Priya Patel",
      ...
      quote:
        "Q-AdMix's unified dashboard gives us complete visibility across all channels. The time we've saved on reporting alone has been worth the investment.",
    },
    {
      avatar: user6,
      name: "James Wilson",
      ...
      quote:
        "The quantum algorithms in Q-AdMix are game-changers. We're seeing optimization patterns that traditional AI would take months to identify.",
    },
  ];
